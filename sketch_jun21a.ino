...
#define http_app  "https://grupoapigas.pythonanywhere.com/gas"  // url da API
...
const char* ssid = "th.mitchel";  // Rede WiFi
const char* password = "vivoporfe";  //Senha da Rede WiFi
...
void loop() {
 ...
 env_Dados(concentracao, http_app, temperatura, umidade);
